package net.oschina.git.justlive1.breeze.storm.cas.client.web;

import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.ANY_PATH;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.CAS_SERVER_LOGINURL;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.CAS_SERVER_LOGINURL_FIELD;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.CAS_SERVER_URL_PREFIX;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.CAS_SERVER_URL_PREFIX_FIELD;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.DEFAULT_CONFIG_PATH;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.IGNORES_URLS;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.IGNORES_URLS_FIELD;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.SERVER_NAME;
import static net.oschina.git.justlive1.breeze.snow.common.web.base.ConfigProperties.SERVER_NAME_FIELD;
...
import net.oschina.git.justlive1.breeze.snow.common.web.util.PropertiesWrapper;
import net.oschina.git.justlive1.breeze.storm.cas.client.util.Cas20ProxyReceivingTicketValidationFilter4Http;
import net.oschina.git.justlive1.breeze.storm.cas.client.util.MultipleAntPathMatcher;
