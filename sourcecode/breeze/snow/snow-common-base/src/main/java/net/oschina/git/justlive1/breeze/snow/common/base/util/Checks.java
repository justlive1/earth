...
public class Checks {
     ...
     * @param mobile
     *            移动、联通、电信运营商的号码段
     *            中国移动：134（不含1349）、135、136、137、138、139、147、150、151、152、157、158、
     *            159、182、183、184、187、188、178
    ...
    public static void decimals(String decimals, Integer decimal, ErrorCode errCode, Object... params) {
