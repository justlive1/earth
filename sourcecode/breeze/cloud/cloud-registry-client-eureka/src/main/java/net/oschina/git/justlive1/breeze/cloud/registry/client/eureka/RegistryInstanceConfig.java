...
public class RegistryInstanceConfig extends MyDataCenterInstanceConfig {
    ...
    public String getVipAddress() {
        ...
        return configInstance.getStringProperty(EurekaRegistryClient.VIP_ADDRESS, super.getIpAddress()).get();
    }
    ...
    public String getHostName(boolean refresh) {
        ...
        return configInstance.getBooleanProperty(EurekaRegistryClient.PREFER_IP_ADDRESS, Boolean.FALSE).get()
                ? getIpAddress()
